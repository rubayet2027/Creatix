  ...
  const contests = [
    {
      ...
      description:
        'Create a complete brand identity including logo, color palette, and typography for a tech startup revolutionizing remote work.',
      image:
    ...
    },
    {
      ...
      description:
        'Capture the essence of city life through compelling street photography that tells stories of urban culture and daily moments.',
      image:
    ...
    },
    {
      ...
      description:
        'Write a compelling short story under 3000 words exploring themes of human connection in the digital age.',
      image:
    ...
    },
    {
      ...
      description:
        'Create stunning digital artwork that pushes the boundaries of imagination. Any digital medium accepted.',
      image:
    ...
    },
    {
      ...
      description:
        'Create an engaging 60-second video that showcases a product in a creative and memorable way.',
      image:
    ...
    },
    {
      ...
      description:
        'Design a beautiful and intuitive user interface for a fitness tracking mobile application.',
      image:
