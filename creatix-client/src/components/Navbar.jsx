                  ...
                  <div className="absolute right-0 mt-2 w-56 rounded-xl bg-[var(--bg-primary)] border border-[var(--border-color)] shadow-xl py-2 animate-in fade-in slide-in-from-top-2 duration-200">
                    ...
                    <div className="px-4 py-3 border-b border-[var(--border-color)]">
                      ...
                      <div className="flex items-center gap-2 mt-1">
                        {dbUser.role === 'admin' && (
                          <span className="inline-flex items-center gap-1 px-2 py-0.5 bg-red-500/10 text-red-600 dark:text-red-400 text-xs font-medium rounded-full">
                            <HiShieldCheck className="w-3 h-3" />
                            Admin
                          </span>
                        )}
                        {dbUser.role === 'creator' && (
                          <span className="inline-flex items-center gap-1 px-2 py-0.5 bg-purple-500/10 text-purple-600 dark:text-purple-400 text-xs font-medium rounded-full">
                        ...
                        {dbUser.creatorStatus === 'pending' && (
                          <span className="inline-flex items-center gap-1 px-2 py-0.5 bg-amber-500/10 text-amber-600 dark:text-amber-400 text-xs font-medium rounded-full">
                    ...
                    {dbUser.role === 'user' && dbUser.creatorStatus !== 'pending' && (
                      <Link
                        ...
                        onClick={() => setProfileDropdown(false)}
                        className="flex items-center gap-2 px-4 py-2 text-sm text-primary-600 dark:text-primary-400 hover:bg-primary-500/10 transition-colors"
                      >
              ...
              <div className="relative" ref={mobileProfileRef}>
                ...
                {profileDropdown && (
                  <div className="absolute right-0 mt-2 w-64 rounded-xl bg-[var(--bg-primary)] border border-[var(--border-color)] shadow-xl py-2 z-50">
                    ...
                    <button
                      onClick={handleLogout}
                      className="flex items-center gap-2 w-full px-4 py-2.5 text-sm text-red-500 dark:text-red-400 hover:bg-red-500/10 transition-colors"
                    >
                      <HiLogout className="w-4 h-4" />
                      Sign Out
                    </button>
                  ...
                  {!isAuthenticated && (
                    <>
                      ...
                      <Link
                        to="/register"
                        onClick={() => setNavDropdown(false)}
                        className="flex items-center gap-3 px-4 py-2.5 text-sm text-primary-600 dark:text-primary-400 hover:bg-primary-500/10 transition-colors"
                      >
