  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-secondary-900 via-secondary-800 to-primary-900">
        ...
        {/* Diagonal accent */}
        <div className="absolute top-0 right-0 w-2/3 h-full" aria-hidden="true">
          <svg
        ...
        {/* Floating elements */}
        <div
          className="absolute top-20 right-1/4 w-4 h-4 bg-primary-400 rounded-full opacity-60 animate-pulse"
          aria-hidden="true"
        />
        <div
          className="absolute top-1/3 right-1/3 w-2 h-2 bg-cyan-400 rounded-full opacity-40 animate-pulse [animation-delay:300ms]"
          aria-hidden="true"
        />
        <div
          className="absolute bottom-1/4 right-1/4 w-3 h-3 bg-emerald-400 rounded-full opacity-50 animate-pulse [animation-delay:700ms]"
          aria-hidden="true"
        />
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              <p className="text-lg text-secondary-300 mb-8 max-w-lg mx-auto lg:mx-0">
                Join the ultimate platform for creative minds. Participate in
                exciting contests, showcase your talent, and win amazing prizes
              ...
              >
                <div className="relative flex flex-col sm:flex-row gap-2 sm:gap-0">
                  ...
                  <button
                    type="submit"
                    className="sm:absolute sm:right-2 sm:top-1/2 sm:-translate-y-1/2 px-6 py-3 sm:py-2 bg-gradient-to-r from-primary-600 to-primary-700 text-white font-medium rounded-xl hover:from-primary-700 hover:to-primary-800 transition-all"
                  >
                    Search
                  </button>
                </div>
            ...
            <div className="hidden lg:block relative" aria-hidden="true">
              <div className="relative z-10">
                ...
                <div className="absolute -bottom-8 -left-8 bg-gradient-to-br from-secondary-800 to-secondary-900 backdrop-blur-xl rounded-2xl border border-white/10 shadow-xl p-4 transform -rotate-6 hover:rotate-0 transition-transform duration-500">
                  <div className="flex items-center gap-3">
                    <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-cyan-400 to-primary-500 flex items-center justify-center">
