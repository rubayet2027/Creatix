...
const MyProfile = () => {
    ...
    const [previewImage, setPreviewImage] = useState(dbUser?.photo || '');
            ...
            <div className="bg-[var(--bg-secondary)] rounded-2xl border border-[var(--border-color)] p-6">
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                    ...
                    <div className="flex items-center gap-6">
                        <div className="relative">
                            <div className="w-24 h-24 rounded-2xl bg-gradient-to-br from-primary-500 to-primary-700 flex items-center justify-center text-white text-3xl font-bold overflow-hidden">
                                {previewImage ? (
                                    <img src={previewImage} alt={dbUser?.name} className="w-full h-full object-cover" />
                                ) : (
                            ...
                            {isEditing && (
                                <div className="absolute -bottom-2 -right-2 flex gap-1">
                                    <button
                                        ...
                                        disabled={uploading}
                                        className="p-2 bg-primary-600 text-white rounded-full hover:bg-primary-700 transition-colors shadow-lg disabled:opacity-50"
                                        title="Upload photo"
                                    >
                                        {uploading ? (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        {/* Hidden photo field for form submission */}
